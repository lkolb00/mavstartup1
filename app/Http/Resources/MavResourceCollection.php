...
class MavResourceCollection extends ResourceCollection
{
     ...
     * @var array
     */
    protected static array $meta = ['meta' => [
     ...
     * @var string
     */
    public $collects = MavResource::class;
    ...
    protected function remove_fields($collection)
    {
        $result = array_map(function ($item) {
            Arr::forget($item, $this->remove_keys);
